...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-28 15:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d45579cd-5a91-486b-8755-6b8bef22feeb.git
$ cd d45579cd-5a91-486b-8755-6b8bef22feeb
```
